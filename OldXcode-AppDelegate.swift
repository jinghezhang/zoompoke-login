...
//    }
    ...
    func application(app: UIApplication, open url: NSURL, options: [String : AnyObject] = [:]) -> Bool {
        return GIDSignIn.sharedInstance().handleURL(url as NSURL!, sourceApplication: options[UIApplicationOpenURLOptionsSourceApplicationKey] as? String, annotation: options[UIApplicationOpenURLOptionsAnnotationKey])
    }
    func application(application: UIApplication, open url: NSURL, sourceApplication: String?, annotation: AnyObject) -> Bool {
        ...
        return GIDSignIn.sharedInstance().handleURL(url as NSURL!, sourceApplication: sourceApplication, annotation: annotation)
    }
